...
### 6. Customize the Cover Illustration (Optional)

The cover features an SVG illustration of a data professional at work. To customize it:

**Option A - Edit the SVG directly in `index.html`:**
The illustration starts around line 23. You can modify colors, add elements, or change the scene entirely.

**Option B - Replace with your own image:**
1. Create or find an illustration (400x320px works best)
2. Save it as `cover-art.jpg` or `cover-art.png`
3. Replace the entire `<svg>` block with:
```html
<img src="cover-art.jpg" alt="Portfolio illustration" style="width: 100%; border-radius: 15px;">
```

**Option C - Use a different pre-made scene:**
The current scene shows someone working at a computer with data visualizations. You could modify it to show:
- Data visualizations on a wall (presentation scene)
- Multiple monitors with dashboards
- A team meeting around data displays
- Abstract data patterns and charts
